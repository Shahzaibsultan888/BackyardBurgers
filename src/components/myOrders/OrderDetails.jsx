      ...
      {loading === false && order !== undefined ? (
        <main>
          ...
          <div>
            ...
            <p>
              <b>Address</b>
              {`${order.shippingInfo.hNo} ${order.shippingInfo.area} ${order.shippingInfo.city} ${order.shippingInfo.pinCode}`}
            </p>
          </div>
          <div>
            <h1>Contact</h1>
          ...
          <article>
            ...
            <div>
              <h4>Chapli Burger</h4>
              <div>
                <span>{order.orderItems.chapliBurger.quantity}</span> x{" "}
                <span>{order.orderItems.chapliBurger.price}</span>
              </div>
            </div>
            <div>
              <h4>Chicken Burger/Fries</h4>
              <div>
                <span>{order.orderItems.chickenBurgerWithFries.quantity}</span> x{" "}
                <span>{order.orderItems.chickenBurgerWithFries.price}</span>
              </div>
            </div>
